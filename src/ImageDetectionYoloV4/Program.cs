...
using ImageDetectionYoloV4.YoloV4;
using Microsoft.ML;
using static Microsoft.ML.Transforms.Image.ImageResizingEstimator;

namespace ImageDetectionYoloV4
{
    ...
    class Program
    {
        ...
        const string modelPath = @"C:\Users\rblouch\source\repos\DotNetPiProjects\src\ImageDetectionYoloV4\Assets\Model\yolov4.onnx";

        const string imageFolder = @"C:\Users\rblouch\source\repos\DotNetPiProjects\src\ImageDetectionYoloV4\Assets\Input";
